...
/* package advent-0.0.0 */
#ifndef VERSION_advent
#define VERSION_advent "0.0.0"
...
/* package invert-1.0.0.3 */
#ifndef VERSION_invert
#define VERSION_invert "1.0.0.3"
#endif /* VERSION_invert */
#ifndef MIN_VERSION_invert
#define MIN_VERSION_invert(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_invert */
...
#define CURRENT_COMPONENT_ID "advent-0.0.0-BrSCzEt5zl3CQ3frNNi4jY-day4"
